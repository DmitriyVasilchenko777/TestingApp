...
const $arrayInputGroupContainerForVopros: NodeListOf<HTMLInputElement> = document.querySelectorAll(".input-container-for-vopros");
const $arrayInputGroupContainerForVopros2: NodeListOf<HTMLInputElement> = document.querySelectorAll(".input-container-for-vopros-2");
const $arrayInputGroupContainerForVopros3: NodeListOf<HTMLInputElement> = document.querySelectorAll(".input-container-for-vopros-3");
const $arrayInputGroupContainerForVopros4: NodeListOf<HTMLInputElement> = document.querySelectorAll(".input-container-for-vopros-4");
const $arrayInputGroupContainerForVopros5: NodeListOf<HTMLInputElement> = document.querySelectorAll(".input-container-for-vopros-5");

const $button: HTMLInputElement = document.querySelector(".button");

// Кнопка начать тест заново 

const $buttonReplay: HTMLInputElement = document.querySelector(".button-replay");

// Сообщение о количестве правильных ответов

const $alertMessageResult: HTMLDivElement = document.querySelector(".alert-message-result");

// Массив правильных ответов

const arrayTrueResponse: string[] = [
    "JavaScript",
...
let countTrueResponse: number = 0;
